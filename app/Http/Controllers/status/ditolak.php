...
if (mysqli_num_rows($tel0) == 1) {
    ...
    $tujuan0    = $row0['no_wa'];
    $pesan0 = "Halo $nama0, PTPP yang anda buat dengan detail : \nNomor : *$nomor* \nJenis PTPP : $jenis \nStatus saat ini : *DITOLAK* \nAnalisa PTPP ini telah berhasil ditolak, PTPP akan dikembalikan dan dianalisa ulang Oleh $k_dept $kepada. Mohon menunggu departemen bersangkutan selesai menganalisa ulang PTPP tersebut. \n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
...
if (mysqli_num_rows($tel2) == 1) {
    ...
    $tujuan2    = $row2['no_wa'];
    $pesan2     = "Halo $nama2, PTPP yang $d_dept $dari buat dengan detail :\nNomor : *$nomor* \nJenis PTPP : $jenis \nStatus Saat ini : *DITOLAK*. \nAnalisa PTPP Telah Ditolak Oleh : $userlogin \nDengan Alasan : $alasan. \n$k_dept $kepada akan segera memberikan analisa baru pada PTPP tersebut. \n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
