<?php {
    ...
    $target         = tgl($data['target_selesai']);
...
$tel0 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE nama_lengkap='$dianalisa' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
$row0 = mysqli_fetch_array($tel0);
if (mysqli_num_rows($tel0) == 1) {
    $nama0      = $row0['nama_lengkap'];
    $tujuan0    = $row0['no_wa'];
    $pesan0     = "Halo $nama0, PTPP yang sudah anda analisa, dengan detail: \nNomor : $nomor \nJenis PTPP : $jenis \nTelah diterima oleh : $d_dept $dari \nStatus Saat Ini adalah : *UNCLOSE* \nHarap memasukan bukti close PTPP sebelum Target Selesai berlalu ($target) \n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
...
$tel1 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='BM' AND cabang='$kepada' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
$row1 = mysqli_fetch_array($tel1);
if (mysqli_num_rows($tel1) == 1) {
    $nama1      = $row1['nama_lengkap'];
    $tujuan1    = $row1['no_wa'];
    $pesan1     = "Halo $nama1, PTPP yang diberikan kepada $k_dept $kepada dengan detail: \nNomor : $nomor \nJenis PTPP : $jenis \nTelah diterima oleh: $d_dept $dari \nStatus Saat Ini adalah : *UNCLOSE* \n$k_dept $kepada harus segera memberikan bukti close PTPP sebelum Target Selesai berlalu ($target). \n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
...
$tel2 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='BM' AND cabang='$dari' AND cabang!='$kepada' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
$row2 = mysqli_fetch_array($tel2);
if (mysqli_num_rows($tel2) == 1) {
    $nama2      = $row2['nama_lengkap'];
    $tujuan2    = $row2['no_wa'];
    $pesan2     = "Halo $nama2, PTPP yang diberikan kepada $k_dept $kepada dengan detail: \nNomor : $nomor \nJenis PTPP : $jenis \nTelah diterima oleh: $d_dept $dari \nStatus Saat Ini adalah : *UNCLOSE* \n$k_dept $kepada akan segera memberikan bukti close PTPP sebelum Target Selesai berlalu ($target). \n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
...
$tel8 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND cabang='$dari' AND id_kirim=1 AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
...
//notif kepada sistem cabang 2
$tel9 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND cabang='$dari' AND id_kirim=2 AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
...
//notif kepada sistem cabang 3
$tel10 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND cabang='$dari' AND id_kirim=3 AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
...
//notif kepada sistem cabang yang membuat PTPP 1
$tel11 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND cabang!='$dari' AND cabang!='HO' AND cabang='$kepada' AND id_kirim=1 AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
...
//notif kepada sistem cabang yang membuat PTPP 2
$tel12 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND cabang!='$dari' AND cabang!='HO' AND cabang='$kepada' AND id_kirim=2 AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
...
//notif kepada sistem cabang yang membuat PTPP 3
$tel13 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND cabang!='$dari' AND cabang!='HO' AND cabang='$kepada' AND id_kirim=3 AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'");
