...
$tel = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE nama_lengkap='$dianalisa' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND dept='$k_dept'");
$row = mysqli_fetch_array($tel);
if (mysqli_num_rows($tel) == 1) {
    $namaa   = $row['nama_lengkap'];
    $tujuan = $row['no_wa'];
    $pesan = "Halo $namaa, PTPP dengan detail: \nNomor : *$nomor* , \nJenis PTPP : $jenis \nTelah diselesaikan oleh : $userlogin, \nStatus Saat Ini adalah : *CLOSE* \nPTPP sudah selesai dan tidak bisa diedit kembali\n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
...
if ($pic !== $dianalisa) {
    // Notif Kepada PIC yang membuat PTPP
    $tel0 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE nama_lengkap='$pic' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'  AND id_kirim=3 ");
    $row0 = mysqli_fetch_array($tel0);
    if (mysqli_num_rows($tel0) == 1) {
        $nama0      = $row0['nama_lengkap'];
        $tujuan0    = $row0['no_wa'];
        $pesan0     = "Halo $nama0, PTPP yang diberikan kepada $k_dept $kepada, dengan detail : \nNomor : *$nomor* , \nJenis PTPP : $jenis \nTelah diterima (Close) oleh: $userlogin \nStatus Saat Ini adalah : *CLOSE* \nPTPP sudah selesai dan tidak bisa diedit kembali \n\n\n```Ini adalah pesan otomatis BOT Arnon Bakery```";
...
$tel1 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='BM' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'  AND cabang='$kepada'");
...
if ($jenis == 'EKSTERNAL') {
    ...
    $tel3 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62'  AND cabang='HO' AND id_kirim=1 ");
    ...
    $tel4 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='HO' AND id_kirim=2 ");
    ...
    $tel5 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='HO' AND id_kirim=3 ");
    ...
    $tel6 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='HO' AND id_kirim=4 ");
    ...
    $tel7 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='HO' AND id_kirim=5 ");
...
if ($kepada !== 'HO') {
    ...
    $tel8 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='$kepada' AND id_kirim=1 ");
    ...
    $tel9 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='$kepada' AND id_kirim=2 ");
    ...
    $tel10 = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE dept='SIS' AND no_wa !='' AND no_wa !=0  AND no_wa !='+62' AND cabang='$kepada' AND id_kirim=3 ");
