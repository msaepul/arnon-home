...
@section('isi')
    <title>App Central - Buat Komunikasi Eksternal</title>
    <?php
    ...
    <section class="content-header" style="margin-top: -3%; margin-bottom: -1%;">
        ...
        {{ Breadcrumbs::render('komeks') }}
    </section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form enctype="multipart/form-data" class="form-horizontal" method="POST"
                    action="{{ route('addkomeks.action') }}">
                    ...
                    <div class="card card-light">
                        <div class="card-header">
                            <div class="form-group row" style="margin-bottom: -1%">
                                ...
                                <div class="col-sm-4">
                                    <h5 class="text-md-center"><b>KOMUNIKASI EKSTERNAL</b></h5>
                                    <h6 class="text-md-center">No..../KOM/.../{{ tgl_id($monthnow) . '/' . $yearnow }}
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
