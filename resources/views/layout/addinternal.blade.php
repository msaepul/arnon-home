...
@section('isi')
    <title>App Central - Buat PTPP Internal</title>
    @php
        ...
        $hasilkode = $kodeMaxp . '/' . $cabang . '/' . tgl_id($monthnow) . '/' . $yearnow;
    @endphp
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-3">
                                    <select
                                        ...
                                        @foreach ($dataKategori as $kat)
                                            <option value="{{ $kat->id }}"
                                                @if (old('kategori') == $kat->id) selected @endif>
                                                {{ $kat->kategori }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control form-control-border" name="subkategori" id="subkategori">
                                        <option value="" selected disabled> ----- </option>
                                        <!-- PRODUK A -->
                                        @foreach ($datasubKategori3 as $kat)
                                            <option value="{{ '3_' . $kat->id }}"
                                                @if (old('kategori') == $kat->id) selected required @endif>
                                                {{ $kat->kategori }}
                                            </option>
                                        @endforeach
                                        @foreach ($datasubKategori8 as $kat)
                                            <option value="{{ '8_' . $kat->id }}"
                                                @if (old('kategori') == $kat->id) selected required @endif>
                                                {{ $kat->kategori }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="hidden" name="kepada" id="kepada" value="{{ cabang() }}">
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $("#subkategori").children('option:gt(0)').hide();
            $("#kategori").change(function() {
                $("#subkategori").children('option').hide();
                $("#subkategori").children("option[value^=" + $(this).val() + "]").show()
            })
        })
