...
@endsection
@section('isi')
    <title>App Central - PTPP Confirm</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="confirm" class="table table-sm table-bordered table-striped user_datatable"
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" type="button"
                                    onclick="window.location='/layout/detail/{{ $d->kode }}?b=confirm'">
