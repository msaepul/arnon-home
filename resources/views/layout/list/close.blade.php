...
@endsection
@section('isi')
    <title>App Central - PTPP Close</title>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">PTPP (CLOSE)</li>
                    </ol>
                </div>
            </div>
        </div> --}}

        {{ Breadcrumbs::render('close') }}
    </section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="close" class="table table-sm table-bordered table-striped user_datatable"
