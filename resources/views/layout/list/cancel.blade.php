...
@endsection
@section('isi')
    <title>App Central - PTPP Batal</title>
    <section class="content-header" style="margin-top: -3%;">
        {{-- <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>PTPP (Batal / Ditolak)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ '/layout/home' }}">Home</a></li>
                        <li class="breadcrumb-item active">PTPP (Batal / Ditolak)</li>
                    </ol>
                </div>
            </div>
        </div> --}}

        {{ Breadcrumbs::render('cancel') }}
    </section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="cancel" class="table table-sm table-bordered table-striped user_datatable"
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" type="button"
                                    onclick="window.location='/layout/detail/{{ $d->kode }}?b=close'">
