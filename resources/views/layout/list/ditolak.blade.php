...
@endsection
@section('isi')
    <title>App Central - PTPP Ditolak</title>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">PTPP (DITOLAK)</li>
                    </ol>
                </div>
            </div>
        </div> --}}

        {{ Breadcrumbs::render('ditolak') }}
    </section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="ditolak" class="table table-sm table-bordered table-striped user_datatable"
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" type="button"
                                    onclick="window.location='/layout/detail/{{ $d->kode }}?b=ditolak'">
