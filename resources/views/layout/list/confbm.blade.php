...
@endsection
@section('isi')
    <title>App Central - PTPP Confirm BM</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="confbm" class="table table-sm table-bordered table-striped user_datatable"
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" type="button"
                                    onclick="window.location='/layout/detail/{{ $d->kode }}?b=confbm'">
