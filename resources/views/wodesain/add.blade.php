...
@section('isi')
    <title>Home App - Buat WO Perubahan Desain</title>
    <?php
    $cabang = cabang();
            ...
            <div class="col-md-6">
                <div class="card card-navy">
                    <div class="card-header">
                        <h3 class="card-title">Work Order Perubahan Desain Kemasan</h3>
                    </div>
                    <form enctype="multipart/form-data" class="form-horizontal" style="zoom: 80%" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="izinedar" class="col-sm-3 col-form-label">Nomor PIRT / BPOM MD</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('izinedar') is-invalid @enderror"
                                        name="izinedar" id="izinedar" value="{{ old('izinedar') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="mui" class="col-sm-3 col-form-label">Nomor MUI</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('mui') is-invalid @enderror"
                                        name="mui" id="mui" value="{{ old('mui') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="deskripsi" class="col-sm-3 col-form-label">Deskripsi Lengkap</label>
                                <div class="col-sm-9">
                    ...
                    <div class="card-body">
                        {{-- @for ($i = 1; $i < 4; $i++)
                            <div class="item col-sm-4 col-md-4 mb-4">
                                ...
                                <center><input style="width: 20px; height: 20px;" type="radio" name="lampiran1"
                                        id="{{ $i }}" value="{{ $roti . $i . '.png' }}">
                                </center>
                            </div>
                            @error('lampiran1')
                        ...
                        <div class="custom-file col-sm-10">
                            ...
                            <label class="custom-file-label" for="lampiran1">Upload QR Code BPOM (jpg, png, jpeg)</label>
                            @error('lampiran1')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
